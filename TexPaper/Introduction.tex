...
either serve structural purposes, by adding in bifurcation ot the structure, or contain states equipped with transition and emission probabilities.
...
end we have developed an algorithm that utilizes the Zhang Shasha Tree Edit distance algorithm, augmented with node to node comparison that uses a HMM Distance comparison 
