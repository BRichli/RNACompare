...
We validate our algorithm as faithfully finding the smallest edit distance between two \cm's in \{fomralism}. To validate the efficacy of our approach we 
...
set. We present these results in \S\arabic{results}.
